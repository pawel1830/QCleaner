    ...
    ui(new Ui::Ustawienia)
{
   ...
   ui->buttonsSave->button(QDialogButtonBox::SaveAll)->setText(tr("Zapisz wszystko"));
   ui->buttonsSave->button(QDialogButtonBox::Cancel)->setText(tr("Anuluj"));
}
...
void Ustawienia::on_buttonsSave_accepted()
{
...
void Ustawienia::PrzywrocDomyslne()
{
    ...
    QMessageBox::information(this,QString::fromUtf8("QCleaner - Ustawienia"),QString::fromUtf8("Przywrócono ustawienia domyślne"));
}
...
void Ustawienia::on_przywDomyslne_clicked()
{
    PrzywrocDomyslne();
    writeSettings();
    Ustawienia::close();
...
void Ustawienia::writeSettings()
 {
    ...
    {
        QSettings settings("QCleaner", "config");
